...
class main_window(Frame):
    ...
    def initUI(self):
        ...
        lbl_par_15.grid(row=6, column=0, sticky=W) #Label para botão de abrir arquivo csv janela de controle & medição
        self.lbl_par_11.grid(row=4, column=1, sticky=E)
        self.lbl_par_12.grid(row=5, column=1, sticky=E)
        
        #---botão de abrir arquivo CSV na janela de controle & medição ----------------
    ...
    # Para o botão de abrir arquivo csv na janela de controle & medição
...
#         print(valor_x)
        ...
        # Passando os valores do arquivo csv lido para a matriz na janela de controle & medição
